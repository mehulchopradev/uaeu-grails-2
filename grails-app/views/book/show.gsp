	...
	<body>
		...
		<div id="show-book" class="content scaffold-show" role="main">
			...
			<ol class="property-list book">
				...
				<g:if test="${bookInstance?.publicationHouse}">
				<li class="fieldcontain">
					<span id="publicationHouse-label" class="property-label"><g:message code="book.publicationHouse.label" default="Publication House" /></span>
					
						<span class="property-value" aria-labelledby="publicationHouse-label"><g:link controller="publicationhouse" action="show" id="${bookInstance?.publicationHouse?.id}">${bookInstance?.publicationHouse?.encodeAsHTML()}</g:link></span>
